...
/** 
  @notice 
  Allows ERC1155 owners to fractionalize their tokens, each ERC1155 will have a fractionalizer.
...
contract Fractionalizer1155 is IOceanPrimitive {
    ...
    */
    ...
    /** 
     @notice 
     Keeps a track of the total number of new fractional tokens registered.
    */ 
    uint256 public registeredTokenNonce;

    /** 
     @notice 
     ERC1155 fractionalized asset ocean id => fungible token id
    */
    mapping(uint256 => uint256) public fungibleTokenIds;

    /** 
     @notice 
     ERC1155 fractionalized asset ocean id => total fungible token supply
    */
    ...
    /**
      ...
      @param exchangeRate_ Number of fractional tokens per each ERC1155 token.
    */
    constructor(
    ...
    */
    ...
    /**
      ...
      @param tokenId ERC 1155 token id of the asset which was fractionalized
